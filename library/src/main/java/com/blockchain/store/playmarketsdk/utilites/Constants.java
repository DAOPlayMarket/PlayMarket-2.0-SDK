...
public class Constants {
    ...
    public static final String VALUE_TRANSFER_AMOUNT = "transfer_amount";
    public static final String VALUE_RECIPIENT_ADDRESS = "recipient_address";
    public static final String VALUE_PASSWORD = "user_password";
